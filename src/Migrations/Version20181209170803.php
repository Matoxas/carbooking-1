 ...
 */
final class Version20181209170803 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE subscribe (id INT AUTO_INCREMENT NOT NULL, city_id INT DEFAULT NULL, brand_id INT DEFAULT NULL, model_id INT DEFAULT NULL, email VARCHAR(55) NOT NULL, date_from DATETIME DEFAULT NULL, date_until DATETIME DEFAULT NULL, price_from DOUBLE PRECISION DEFAULT NULL, price_until DOUBLE PRECISION DEFAULT NULL, INDEX IDX_68B95F3E8BAC62AF (city_id), INDEX IDX_68B95F3E44F5D008 (brand_id), INDEX IDX_68B95F3E7975B7E7 (model_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE booking (id INT AUTO_INCREMENT NOT NULL, car_id INT DEFAULT NULL, users_id INT NOT NULL, booked_from DATETIME NOT NULL, booked_until DATETIME NOT NULL, message LONGTEXT DEFAULT NULL, approved TINYINT(1) NOT NULL, INDEX IDX_E00CEDDEC3C6F69F (car_id), INDEX IDX_E00CEDDE67B3B43D (users_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE subscribe ADD CONSTRAINT FK_68B95F3E44F5D008 FOREIGN KEY (brand_id) REFERENCES brand (id)');
        $this->addSql('ALTER TABLE subscribe ADD CONSTRAINT FK_68B95F3E7975B7E7 FOREIGN KEY (model_id) REFERENCES model (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE subscribe DROP FOREIGN KEY FK_68B95F3E44F5D008');
        ...
        $this->addSql('ALTER TABLE subscribe DROP FOREIGN KEY FK_68B95F3E7975B7E7');
